...
- Lead_Scoring_Case_Study_Group_ONS.ipynb : The python file showing coding and data analysis
- CASE_STUDY_SUBJECTIVE_QUESTIONS.pdf : Some subjective questions and its answers.
- LEAD_SCORE_CS_PPT.pdf : Final Presentation
- Leads.csv : Data worked on
- Leads Data Dictionary.xlsx : Data Dictionary
- SUMMARY_LEAD_CS.pdf : Summary on what's done in the entire py file
